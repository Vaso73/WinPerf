...
public sealed class LanguagePackService
{
    ...
    private static Dictionary<string, string> CreateBuiltInEnglishTexts()
    {
        return new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Update available: {0}"] = "Update available: {0}",
            ...
            ["Connected to {0} / {1}."] = "Connected to {0} / {1}.",
            ["Open app settings and information"] = "Open app settings and information",
            ...
            ["{0} active · updates channel ready"] = "{0} active · updates channel ready",
    ...
    private static Dictionary<string, string> CreateBuiltInSlovakTexts()
    {
        return new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Update available: {0}"] = "Dostupná aktualizácia: {0}",
            ...
            ["Connected to {0} / {1}."] = "Pripojené k {0} / {1}.",
            ["Open app settings and information"] = "Otvoriť nastavenia aplikácie a informácie",
            ...
            ["↑ {0} · ↓ {1}   ↑ avg {2} · ↓ avg {3}"] = "↑ {0} · ↓ {1}   ↑ avg {2} · ↓ avg {3}",
            ["{0} active · updates channel ready"] = "{0} aktívny · aktualizačný kanál pripravený",
