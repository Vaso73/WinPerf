...
public sealed class VersionMetadataTests
{
    ...
    public void DirectoryBuildProps_DefinesInitialReleaseVersion()
    {
        ...
        Assert.Contains("<VersionPrefix>0.1.1</VersionPrefix>", props);
        Assert.Contains("<Version>$(VersionPrefix)</Version>", props);
        Assert.Contains("<AssemblyVersion>0.1.1.0</AssemblyVersion>", props);
        Assert.Contains("<FileVersion>0.1.1.0</FileVersion>", props);
